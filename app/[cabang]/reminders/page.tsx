    ...
    <div style={{ padding: "var(--page-py) var(--page-px)", maxWidth: 860 }}>
      ...
      {total === 0 && lewatTempo.length === 0 ? (
        ...
        <>
          ...
          {/* Belum Bayar */}
          <ReminderSection title="⏳ Belum Bayar" color="var(--brand)" icon={Clock} count={belumBayar.length}>
            {belumBayar.length === 0 ? (
                ...
                <DriverCard
                  ...
                  detail={
                    <div style={{ display: "flex", gap: 12, marginTop: 2, flexWrap: "wrap" }}>
                      ...
                      {dl >= 0
                        ? <span style={{ fontSize: 12, color: "var(--brand)", fontWeight: 600 }}>Sisa {dl} hari</span>
